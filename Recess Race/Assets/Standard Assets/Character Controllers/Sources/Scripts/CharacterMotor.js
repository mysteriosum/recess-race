...
private function ApplyGravityAndJumping (velocity : Vector3) {
	...
	if (grounded)
		...
		if (jumping.jumping && jumping.holdingJumpButton) {
			...
			if (Time.time < jumping.lastStartTime + (jumping.extraHeight + (inputRun? jumping.extraRunHeight : 0)) / CalculateJumpVerticalSpeed(jumping.baseHeight)) {
...
private function GetDesiredHorizontalVelocity () {
	...
	var maxSpeed : float = inputRun? movement.maxRunSpeed : movement.maxWalkSpeed;
	if (grounded) {
